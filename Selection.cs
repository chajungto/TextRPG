        ...
        public void StartEvent()
        {
            switch (EventNumber)
            {
                ...
                case 1:
                    ...
                    else if (ChoosedIndex_01 == 2)
                    {
                        if (ch.isGoldExist(ch.Gold - 50) && !ItemList[18].IsOwned)
                        {
                            ...
                            Console.WriteLine("인형에 Rabbit1 이라고 써져있다.");
                        }
                ...
                case 5:
                    ...
                    Item FightingItem = new Item(19, "응원", "난 항상 널 응원하고 있어 (중첩 가능)", "공격력 + 5, 방어력 + 3", 5, 3, 100, false);
                ...
                case 6:
                    ...
                    if(ChoosedIndex_06 == 1)
                    {
                        if(!ItemList[13].IsOwned)
                        {
                            ...
                            Console.WriteLine("아이템 {0} 획득", ItemList[13].Name);
                        }
                        else
                        {
                            Console.ForegroundColor = ConsoleColor.Yellow;
                ...
                case 8:
                    ...
                    Thread.Sleep(1500);
                    Console.WriteLine("당신이 원하는 대로 누를수 있다는 듯이죠.");
                    Thread.Sleep(1500);
                    Console.WriteLine("자 니제 선택의 시간이 다가온 것 같습니다.");
                    Thread.Sleep(1500);
